...
// play with these parameters from p5.js
uniform float amt; // the amount of displacement, higher is more
uniform float squares; // the number of squares to render vertically
